...
//Login Facebook
.controller('LoginFacebookCtrl', function($scope, $state, $templateCache, $q, $rootScope) {
	$scope.doLogIn = function(){
		$state.go('app.home-myceleb-page');
	};
...
//Login Independent
.controller('LoginIndependentCtrl', function($scope, $state, $templateCache, $q, $rootScope) {
	$scope.doLogIn = function(){
		$state.go('app.home-myceleb-page');
	};
...
//Signup Independent
.controller('SignupIndependentCtrl', function($scope, $state) {
	$scope.user = {};
...
//Home Celeb Page
.controller('HomeMyCelebPageCtrl', function($scope, $http) {
...
//Home New Page
.controller('HomeNewPageCtrl', function($scope, $http) {
	$scope.feeds_categories = [];
...
//Home popular Page
.controller('HomePopularPageCtrl', function($scope, $http) {
	$scope.feeds_categories = [];
...
// Following
.controller('FollowingCtrl', function($scope, $rootScope, BookMarkService, $state) {
