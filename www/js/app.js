...
// ==== Auth ====
  ...
  .state('auth.walkthrough', {
	...
	// 1.1 login facebook page
	.state('auth.login-facebook', {
		url: '/login-facebook',
		templateUrl: "views/auth/login-facebook.html",
		controller: 'LoginFacebookCtrl'
	})

	// 1.2 login Independent page
	.state('auth.login-independent', {
		url: '/login-independent',
		templateUrl: "views/auth/login-independent.html",
		controller: 'LoginIndependentCtrl'
	})
	
	// 1.3 signup Independent
	.state('auth.signup-independent', {
		url: '/signup-independent',
		templateUrl: "views/auth/signup-independent.html",
		controller: 'SignupIndependentCtrl'
	})

// ==== FEED ==== 	
// Home page 1 (My Celeb)
  .state('app.home-myceleb-page', {
    url: "/home-myceleb-page",
    views: {
      'menuContent': {
        templateUrl: "views/app/home/home-myceleb-page.html",
        controller: 'HomeMyCelebPageCtrl'
      }
    }
  })
  
// Home page 2 (New)
  .state('app.home-new-page', {
    url: "/home-new-page",
    views: {
      'menuContent': {
        templateUrl: "views/app/home/home-new-page.html",
        controller: 'HomeNewPageCtrl'
      }
    }
  })
  
// Home page 3 (popular)
  .state('app.home-popular-page', {
    url: "/home-popular-page",
    views: {
      'menuContent': {
        templateUrl: "views/app/home/home-popular-page.html",
        controller: 'HomePopularPageCtrl'
      }
    }
  })
